    ...
    for p0 in seq_p:
        ...
        while count < precesion_control:
            ...
            if status_full == 'solution':
                ...
                result, len_trajectory, discovered_maze, processed, explored, rp, rp1, rp2, planning_time = fun_repeated_Astar_p2(
                    initial_maze, dim)
                ...
                sum_traj_spD = sum_traj_spD + \
                    (len_trajectory/len_sp_discovered)
    ...
    for p0 in seq_p:
        ...
        while count < precesion_control:
            ...
            if status_full == 'solution':
                ...
                ###---run repeated A*--------###
                start_time = time.process_time_ns()
                result, len_trajectory, discovered_maze, processed, explored, rp, planning_time = fun_repeated_Astar_Q7_p2(
                    initial_maze, dim)
                end_time = time.process_time_ns()
                count = count + 1
                sum_traj = sum_traj + len_trajectory
...
if __name__ == '__main__':
    ...
    getQ6Graph(dim, maxP, huristic_option, stepsize, precesion_control, seq_p)
    getQ7Graph(dim, maxP, huristic_option, stepsize, precesion_control, seq_p)
