...
from project2_agent12_run import *
import numpy as np
...
def average_trajectory_vs_all(dimensions, density, iteration, huristic_option, stepsize):
    for i, dim in enumerate(dimensions):
        ...
        average_trajectory_len_agent_1 = getQ6Graph(
            dim, p, huristic_option, stepsize, iteration, density)
        average_trajectory_len_agent_2 = getQ7Graph(
            dim, p, huristic_option, stepsize, iteration, density)
        ...
        time_vs_density_3_vs_4(
            dim, collection_time_agent_3, collection_time_agent_4)
        processed_cells_3_vs_4(
            dim, processed_cells_agent_3, processed_cells_agent_4)
